...
(function(root){
  ...
  var LIBRARY=[
    ...
    {id:"tiers", q:"Which fits me, Your Dojo or R2 Hosting?",
     ...
     keys:"difference tier tiers plan plans option options sensei runs run compare comparison versus vs choose pick between package packages custom bigger",
     a:"<p>It is me doing the building either way. The difference is what stands at the end.</p><p>R2 Hosting, $222 to build then $99 a month: a website or small app, hosted and managed on my stack, no Dojo yet. Your Dojo, $2,222 a month: the audit, the command center, the trained ninjas, the factories behind your repeated work, hosted and kept running, with me overseeing it as your sensei. I help you run it; your team runs the daily DO and presses every send. Sensei runs it, the card where I ran the whole day for you, is off the page. If that is what you need, or you are bigger than one Dojo, it is a custom price and we talk first.</p>",
     link:{href:"#offers", label:"See the offers"}},

    {id:"r2-hosting", q:"What is R2 Hosting?",
     alt:["r2 hosting","r2","need a website","need a site","host my site","host my website","host it","just a website","just a site","only a website","small app","build a website","build my website","entry level","start small","smallest","cheapest","starter","99 a month","222"],
     keys:"r2 hosting host hosted hosting website site domain ssl firewall backups updates upkeep 222 99 999 year yearly small smallest starter entry cheapest",
     a:"<p>R2 is me, Rick Tew. The entry level, and the work I actually do most. I build your website or small app from parts that already run in my own businesses, then I host it, manage it and keep it up to date on my stack: domain, SSL, firewall, backups, updates. No logins to share, nothing for you to renew.</p><p>$222 once to build, first month included, then $99 a month or $999 a year. Cancel anytime, effective at the end of the paid month or year. Four businesses run on the stack I manage today, Evercoolthailand, SabaiSen, NinjaGym and PreferClinic, and two pay this exact bill. New features beyond upkeep are quoted separately, in writing first. An AI workforce for the admin is Your Dojo, not this, and an R2 site grows into one.</p>",
    ...
    {id:"side-hustle-summit", q:"Seen the Side Hustle Summit? What does it sell, and do I need it?",
     ...
     a:"<p>Five free sessions on YouTube between 6 and 13 September 2026, and on the second day a program called Monetise: $1,995 in one payment or from about $166 a month on finance, two $25 add-ons at the checkout, a $995 offer after it, a seven-day refund. The host said on day one that the paid offer is what pays for the free week.</p><p>What the week taught can be done with what you already have: one person with one problem, the answer written from public sources with the references, a short guide, put where those people already gather. The gathering place is small Instagram creators with no product, found by hand; their way of reaching them is a $597 a month cold-email platform. The finale built nothing on screen and the price never moved. I do not sell a course for it. I build systems for businesses that already exist, and if that is you, the quiz on this page says what I would build, no email asked.</p>",
    ...
    {id:"how-to-start", q:"How do I start? Is there a call, or do I just pay?",
     ...
     a:"<p>Three doors. Not sure which offer fits: the quiz, twelve taps, no email needed. Want to talk first: write in the mailbox at the bottom and say so. We talk in writing, the mailbox and then email, so everything we agree is on the record; a call is a custom thing, for the builds that need one. Already decided: skip the back and forth and fill in The Intake, twenty to forty minutes of buttons, your own words and a voice note or a short video of how the work runs today. A plan comes back, and that is what gets the build going faster. Nothing is paid before the scope is agreed.</p>",
    ...
    {id:"front-desk", q:"What is The Front Desk?", sol:"The Front Desk",
     ...
     a:"<p><b>Support replies drafted on auto. You press send.</b> An AI reads every support mail, day and night, and drafts the reply from your own written answers. You read, you press send. Runs in my business today.</p><p>Where it runs: my gym's desk, my spa's desk agent, and a coaching team's inbox, each one drafting from that business's own written answers.</p>",
     cta:{what:"The Front Desk", kind:"build", note:"Support replies drafted on auto. You press send."}},
    ...
    {id:"colleagues", q:"What is Colleagues by Email?", sol:"Colleagues by Email",
     ...
     a:"<p><b>AI agents you mail like staff.</b> AI workers with their own mailboxes. Ask the numbers desk a question from your phone; the answer comes back by mail. None of them touch money or the outside world. Mine work this way today.</p>",
    ...
    {id:"marketing-room", q:"What is The Marketing Room?", sol:"The Marketing Room",
     ...
     a:"<p><b>Campaigns drafted in your voice, on auto.</b> A brief goes in, three drafts come out in your voice. Only the one you approve goes out, and the day's numbers land in one glance. Live in daily use.</p>",
    ...
    {id:"ad-room", q:"What is The Ad Room?", sol:"The Ad Room",
     ...
     a:"<p><b>Ad math and ad copy before you spend.</b> It works out what your ads must deliver, drafts the copy for your approval, and never spends a cent itself. You hold the wallet.</p>",
    ...
    {id:"answer-engine", q:"What is The Answer Engine?", sol:"The Answer Engine",
     ...
     a:"<p><b>Your knowledge base, answering 24/7.</b> The brain behind the chat box and the drafted replies. It answers only from facts you checked and says \"I don't know\" rather than guess. Every miss it logs makes your library smarter.</p><p>Where it runs: the chat on my spa's site, in English and Thai, answering from a written studio guide, and the box you are typing into now is its simplest form.</p>",
    ...
    {id:"notebook", q:"What is The Notebook?", sol:"The Notebook",
     ...
     a:"<p><b>Your AI learns. You hold the veto.</b> Your AI gets smarter only by proposing notes you approve, and nothing is ever deleted, so you always know what it knows. On in my own agents today.</p>",
     cta:{what:"The Notebook", kind:"build", note:"Your AI learns. You hold the veto."}},
  ...
  var TIPS={
    ...
    "tiers":"If a site is the whole ask, R2 Hosting. If the admin eats your week, Your Dojo. If nobody on your side can press send, write to me and we talk about a custom price.",
    ...
    "how-to-start":"If you already know what you want off your plate, The Intake is faster than a back and forth. Bring three real cases: an easy one, a weird one, and the last mistake.",
    "cancel":"The exit is the honest test of any service. Ask any provider two things: what leaves with me, and what do I owe after. Here: your domain, your content and your data, and nothing.",
    ...
    "no-business":"Step one takes an evening: one person, one problem, written down.",
    "course":"Ask any seller what lands in your inbox on Monday morning. A course lands homework.",
    "if-you-disappear":"What is yours is written down in the Terms, section 4. Read that page before any other.",
