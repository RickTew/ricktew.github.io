...
(function(root){
  ...
  var LIBRARY=[
    ...
    {id:"how-to-start", q:"How do I start? Is there a call, or do I just pay?",
     ...
     a:"<p>Three doors, all free to open. Not sure which offer fits: the quiz, twelve taps, no email needed. Want to talk first: write in the mailbox at the bottom and say so. We talk in writing, the mailbox and then email, so everything we agree is on the record; a call is a custom thing, for the builds that need one. Already decided: skip the back and forth and fill in The Intake, twenty to forty minutes of buttons, your own words and a voice note or a short video of how the work runs today. A plan comes back, and that is what gets the build going faster. Nothing is paid before the scope is agreed.</p>",
