...
(function(root){
  ...
  var LIBRARY=[
    ...
    {id:"tiers", q:"What is the difference between Sensei runs it and Your Dojo?",
     alt:["difference between","sensei runs it","your dojo","which tier","which plan","which one","two options","two offers","three offers","the two","the three"],
    ...
    {id:"included", q:"What exactly is included in Your Dojo?",
     ...
     a:"<p>Your Dojo, $2,222 a month, straight off the card. The audit first: where the hours go, mapped with you. I build your Dojo: the command center, the trained AI ninjas, the factories behind your repeated work. Your team runs the daily DO; every send, pay and post stays behind your press. Me on call as your sensei: belts advance, new ninjas join as you grow. Not included: running your daily work for you (that is Sensei runs it, $4,444), building products you sell (a separate engagement, scoped in writing first), and third-party costs, your AI, software and ad accounts stay in your name.</p>",
