...
var GOLD=[
  ...
  ["is it safe to let an AI read my inbox", "inbox-security"],
  ["can I give the AI access to my email", "inbox-security"],
  ["agents are now your customers, what does that mean for me", "agent-ready"],
  ["can my pricing be readable to an agent", "agent-ready"],
  ["can somebody's assistant deal with you instead of them", "agent-ready"],
  ["does anyone test it before my customers see it", "tested-first"],
  ["is there a sandbox where agents test my software", "tested-first"],
