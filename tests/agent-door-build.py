...
"- Your Dojo: $%s a month. Rick builds it, hosts it, and helps you run it; the client's team presses every send. Monthly, flat, any number of people, cancel any time. A first contact is free."%P['Your Dojo'],
